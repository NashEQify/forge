...
| Drift detection | none | `consistency_check` skill with 12 checks |
...
| Consistency check (12 checks) | [`../skills/consistency_check/SKILL.md`](../skills/consistency_check/SKILL.md) |
