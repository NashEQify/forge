...
the same lens across six reviewers produces multiple LOW findings
on the same axis that all get deferred — bundle-task theater.
...
catch is exactly the over-fire pattern the value-floor exists to
catch.
