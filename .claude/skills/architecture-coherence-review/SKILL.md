...
description: Cross-spec coherence review for specs that share contracts. 7-dimension extraction, interface-contract assembly, advisory board. Formalized from Task 274 experience. Triggers when 2+ specs share contracts/interfaces and cross-spec coherence must be checked (review execute, type=arch); NOT for single-spec quality (use spec_board).
---
...
**SoT:** `skills/architecture_coherence_review/SKILL.md`
